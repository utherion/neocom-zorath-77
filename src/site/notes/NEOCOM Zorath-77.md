...
:root {
    ...
    --eve-gold: #D4AF37; --eve-gold-dim: #8B6914;
    --eve-gold-glow: rgba(212,175,55,0.25);
    --eve-cyan: #7DF9FF; --eve-cyan-dim: #2a6b70;
    --eve-red: #ff4d4d; --eve-red-dim: #522;
    --eve-bg: #010102; --eve-bg-panel: rgba(8,9,12,0.96);
    --eve-border: #2a2a2e; --eve-border-dim: #1a1a1e;
...
.eve-index-table tr.lang-hdr td { background: linear-gradient(90deg,rgba(212,175,55,0.12),rgba(212,175,55,0.02) 60%,transparent); padding: 7px 14px; border-bottom: 1px solid rgba(212,175,55,0.2); font-family: var(--font-ui); color: var(--eve-gold); font-size: 10px; letter-spacing: 3px; }
.eve-index-table tr.folder-hdr td { padding: 6px 14px 6px 20px; border-bottom: 1px solid #1a1a1e; background: rgba(255,255,255,0.006); font-family: var(--font-ui); color: #888; font-size: 11px; letter-spacing: 2px; text-transform: uppercase; }
.eve-index-table tr.file-row td { padding: 9px 8px; border-bottom: 1px solid rgba(255,255,255,0.025); }
...
<div class="eve-content">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td style="padding:18px 24px;vertical-align:middle;">
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr><td width="120" style="font-family:'Electrolize',monospace;color:#444;font-size:9px;letter-spacing:2px;text-transform:uppercase;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Designation</td><td style="font-family:'Rajdhani',sans-serif;color:#f0f0f0;font-size:18px;font-weight:700;letter-spacing:1px;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Ithika Zorath</td></tr>
            <tr><td style="font-family:'Electrolize',monospace;color:#444;font-size:9px;letter-spacing:2px;text-transform:uppercase;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Bio-Tech</td><td style="font-family:'Share Tech Mono',monospace;color:#7DF9FF;font-size:12px;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Capsuleer <span style="color:#3a7a7e;">[ ACTIVE ]</span></td></tr>
            <tr><td style="font-family:'Electrolize',monospace;color:#444;font-size:9px;letter-spacing:2px;text-transform:uppercase;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Origin</td><td style="font-family:'Rajdhani',sans-serif;color:#999;font-size:14px;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Nafomeh III</td></tr>
            <tr><td style="font-family:'Electrolize',monospace;color:#444;font-size:9px;letter-spacing:2px;text-transform:uppercase;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">Allegiance</td><td style="font-family:'Cinzel',serif;color:#D4AF37;font-size:14px;padding:6px 0;border-bottom:1px solid rgba(212,175,55,0.07);">House Tash-Murkon</td></tr>
            <tr><td style="font-family:'Electrolize',monospace;color:#444;font-size:9px;letter-spacing:2px;text-transform:uppercase;padding:6px 0;">Timestamp</td><td style="font-family:'Share Tech Mono',monospace;color:#333;font-size:11px;padding:6px 0;letter-spacing:1px;">YC128.02</td></tr>
          </table>
        </td>
      </tr>
    </table>
  ...
  <div style="border:1px solid #2a2a2e;background:rgba(0,0,0,0.7);margin-bottom:24px;">
    <table class="eve-index-table">
      ...
      <tr class="file-row">
        <td style="width:30px;padding-left:30px;"><span style="font-size:7px;color:#2a2a2a;">▶</span></td>
        <td><svg width="13" height="13" viewBox="0 0 14 14" style="vertical-align:middle;margin-right:8px;"><rect x="1" y="1" width="9" height="12" rx="0.5" fill="#0a1520" stroke="#7DF9FF" stroke-width="0.8"/><line x1="3" y1="4" x2="8" y2="4" stroke="#7DF9FF" stroke-width="0.6" opacity="0.6"/><line x1="3" y1="6" x2="8" y2="6" stroke="#7DF9FF" stroke-width="0.6" opacity="0.4"/><line x1="3" y1="8" x2="6" y2="8" stroke="#7DF9FF" stroke-width="0.6" opacity="0.4"/></svg><a href="FR - ARCHIVES OF HOUSE TASH-MURKON">FR — ARCHIVES OF HOUSE TASH-MURKON</a></td>
